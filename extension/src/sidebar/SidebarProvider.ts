...
import type { SessionBuffer } from "../buffer";
import type { ApiClient } from "../apiClient";

export class SidebarProvider implements vscode.WebviewViewProvider {
  public static readonly VIEW_ID = "mistakememo.sidebarView";
  ...
  constructor(
    ...
    private readonly getCapture: () => boolean,
    private readonly setCapture: (v: boolean) => void
  ) {}
  ...
  public notifyExtraction(exp: unknown, reason: string): void {
